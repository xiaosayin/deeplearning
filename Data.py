...
def data_get(VoxelTrain,SegTrain,VoxelTest,SegTest):
        ...
        path = "/home/yinwenpei/machine_learning/train_val"  # 文件夹目录
        ...
        # 读取test
        path2 = "/home/yinwenpei/machine_learning/test"
        ...
        # 读取csv   Label信息
        with open('/home/yinwenpei/machine_learning/train_val.csv','r') as csvfile:
